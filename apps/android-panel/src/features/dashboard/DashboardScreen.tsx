...
// Cada botão mostra o rótulo autoritativo vindo do catálogo do Mac quando
// disponível; um actionId sem correspondência aparece "indisponível" em
// vez de travar o app (§10.4).
